...
unsigned char nextByte(char curLine[])
{
...
{ 
    ...
    {
        unsigned char curByte = nextByte(fullText);
        ...
        case 0x00: printf("NOP\n");
            break;
        case 0x01: unsigned char secondByte = nextByte(fullText);
        unsigned char thirdByte = nextByte(fullText);
        ...
        case 0x05: printf("DCR  B\n");
            break;
        case 0x06: secondByte = nextByte(fullText);
        printf("MVI  B,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x0d: printf("DCR  C\n");
            break;
        case 0x0e: secondByte = nextByte(fullText); 
        printf("MVI  C,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x10: printf("");
            break;
        case 0x11: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        ...
        case 0x15: printf("DCR  D\n");
            break;
        case 0x16: secondByte = nextByte(fullText);
        printf("MVI  D,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x1d: printf("DCR  E\n");
            break;
        case 0x1e: secondByte = nextByte(fullText);
        printf("MVI  E,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x20: printf("");
            break;
        case 0x21: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("LXI  H,#$%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0x22: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("SHLD $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        ...
        case 0x25: printf("DCR  H\n");
            break;
        case 0x26: secondByte = nextByte(fullText);
        printf("MVI  H, #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x29: printf("DAD  H\n");
            break;
        case 0x2a: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("LHLD #$%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        ...
        case 0x2d: printf("DCR  L\n");
            break;
        case 0x2e: secondByte = nextByte(fullText);
        printf("MVI  L,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x30: printf("");
            break;
        case 0x31: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("LXI  SP,#$%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0x32: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("STA  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        ...
        case 0x35: printf("DCR  M\n");
            break;
        case 0x36: secondByte = nextByte(fullText);
        printf("MVI  M,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0x39: printf("DAD  SP\n");
            break;
        case 0x3a: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("LDA  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        ...
        case 0x3d: printf("DCR  A\n");
            break;
        case 0x3e: secondByte = nextByte(fullText);
        printf("MVI  A,#$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xc1: printf("POP  B\n");
            break;
        case 0xc2: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JNZ  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xc3: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JMP  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xc4: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CNZ  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xc5: printf("PUSH B\n");
            break;
        case 0xc6: secondByte = nextByte(fullText);
        printf("ADI  #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xc9: printf("RET\n");
            break;
        case 0xca: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JZ   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xcb: printf("");
            break;
        case 0xcc: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CZ   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xcd: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CALL $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xce: secondByte = nextByte(fullText);
        printf("ACI  $%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xd1: printf("POP  D\n");
            break;
        case 0xd2: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JNC  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xd3: secondByte = nextByte(fullText);
        printf("OUT  $%02x\n", secondByte);
        codeNum++;
            break;
        case 0xd4: secondByte = nextByte(fullText);
        printf("CNC  $%02x\n", secondByte);
        codeNum++;
            break;
        case 0xd5: printf("PUSH D\n");
            break;
        case 0xd6: secondByte = nextByte(fullText);
        printf("SUI  $%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xd9: printf("");
            break;
        case 0xda: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JC   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xdb: secondByte = nextByte(fullText);
        printf("IN   #$%02x\n", secondByte);
        codeNum++;
            break;
        case 0xdc: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CC   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xdd: printf("");
            break;
        case 0xde: secondByte = nextByte(fullText);
        printf("SBI  #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xe1: printf("POP  H\n");
            break;
        case 0xe2: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JPO  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xe3: printf("XTHL\n");
            break;
        case 0xe4: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CPO  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xe5: printf("PUSH H\n");
            break;
        case 0xe6: secondByte = nextByte(fullText);
        printf("ANI  #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xe9: printf("PCHL\n");
            break;
        case 0xea: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JPE  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xeb: printf("XCHG\n");
            break;
        case 0xec: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CPE  $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xed: printf("");
            break;
        case 0xee: secondByte = nextByte(fullText);
        printf("XRI  #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xf1: printf("POP  PSW\n");
            break;
        case 0xf2: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JP   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xf3: printf("DI\n");
            break;
        case 0xf4: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CP   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xf5: printf("PUSH PSW\n");
            break;
        case 0xf6: secondByte = nextByte(fullText);
        printf("ORI  #$%02x\n", secondByte);
        codeNum++;
            break;
        ...
        case 0xf9: printf("SPHL\n");
            break;
        case 0xfa: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("JM   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xfb: printf("EI\n");
            break;
        case 0xfc: secondByte = nextByte(fullText);
        thirdByte = nextByte(fullText);
        printf("CM   $%02x%02x\n", thirdByte, secondByte);
        codeNum += 2;
            break;
        case 0xfd: printf("");
            break;
        case 0xfe: secondByte = nextByte(fullText);
        printf("CPI  #$%02x\n", secondByte);
        codeNum++;
            break;
